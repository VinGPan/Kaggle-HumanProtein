...
def resnet_retinanet(num_classes, backbone='resnet50', inputs=None, modifier=None, **kwargs):
    ...
    if backbone == 'resnet50':
        resnet = keras_resnet.models.ResNet50(inputs, classes=28, include_top=True, freeze_bn=True)
    elif backbone == 'resnet101':
        resnet = keras_resnet.models.ResNet101(inputs, classes=28, include_top=True, freeze_bn=True)
    elif backbone == 'resnet152':
        resnet = keras_resnet.models.ResNet152(inputs, classes=28, include_top=True, freeze_bn=True)
    else:
    ...
    return resnet# retinanet.retinanet(inputs=inputs, num_classes=num_classes, backbone_layers=resnet.outputs[1:], **kwargs)
